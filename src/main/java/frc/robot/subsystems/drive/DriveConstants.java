...
public class DriveConstants {
  ...
  public static final double trackWidth = Units.inchesToMeters(22 - 1.75 * 2);
  public static final double wheelBase = Units.inchesToMeters(28 - 1.75 * 2);
  ...
  public static final double wheelRadiusMeters = Units.inchesToMeters(1.429);
